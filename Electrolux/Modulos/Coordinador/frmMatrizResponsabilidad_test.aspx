...
<script>
    $(document).ready(function () {
        ...
        // ###	Funciones del Flujo     							###
        // ############################################################
        //function retornavalor(e,i) { return this.e[i].categoryName; }
        function onRefresh(e) {
     
            //var valor = retornavalor(e, i); 
           /* var rol = new kendo.data.HierarchicalDataSource({
                data:[
				{ categoryName:eval(e.categoryName,
          ...
          //***HTML CODE*** COPY PASTE IT IN HTML PAGE
          <div id="$treeview$" class="demo-section"></div>
                     
          //***JS CODE**
          //to get more TreeView  options please refer http://demos.kendoui.com/web/treeview/remote-data.html
        ...
        callScript(strInterOpAs("clsMatrizResponsabilidad", "lista", "Coordinador"), '', onRefresh);
